...
A custom MultiQC report is generated for each experiment by [./bin/process_QC.py]. This process also defines gene, UMI, ribosomal, hemoglobin, mitochondrial, and "counts" outliers which may be passed to Gemma for optional masking from linear models of gene expression (`--mask`).
...
where $M$ is the metric of interest (pct\_counts\_mito, pct\_counts\_ribo, pct\_counts\_hb, log1p_gene_counts, log1p_UMI_counts) generated by `scanpy.pp.calculate_Qc_metrics`,  
...
A [benchmarking multiQC report](./images/PTSDBrainomics_scvi_whole_cortex_multiqc.html) was generated from https://github.com/rachadele/nextflow_eval_pipeline.
